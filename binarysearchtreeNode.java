...
public class binarysearchtreeNode {
	...
	public binarysearchtreeNode(int i, binarysearchtreeNode p,
			binarysearchtreeNode l, binarysearchtreeNode r) {
		item = i;
		parent = p;
		left = l;
		right = r;
	...
	public int insertElement(int newitem, binarysearchtreeNode node) {
		binarysearchtreeNode b2 = new binarysearchtreeNode(newitem, null, null,
				null);
